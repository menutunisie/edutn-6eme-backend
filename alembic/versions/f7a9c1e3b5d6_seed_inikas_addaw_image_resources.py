"""seed 2 Resource for انعكاس الضّوء (phases 4 et 6)
...
Cree 2 Resource sous la Lesson "انعكاس الضّوء" (Eveil scientifique, Axis
الضّوء) et ajoute resource_id sur les entrees d'ordre 4 et 6 de
...
down_revision: Union[str, None] = 'e5c7a9b1d3f4'
...
_IMAGES = [
    (4, "phase4-p19.png", "تجربة انعكاس الضّوء بمرآة"),
    (6, "phase6-p19.png", "4 حالات أشعّة على مرآة مستوية"),
]
...
def _resource_id(filename: str) -> uuid.UUID:
    return uuid.uuid5(NAMESPACE, f"resource.SCIENCE.inikas-ad-daw.{filename}")
